...
import {analyzeClassroomTeachingFrame, analyzeClassroomVisualAlerts, analyzeDeliveryTask, classifyVisionScene, detectClassroomPeople, generateTeachingText, getGeminiModel, isOllamaConfigured} from './aiService';

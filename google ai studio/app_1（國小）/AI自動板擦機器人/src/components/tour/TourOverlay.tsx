...
const cardTitle: React.CSSProperties = {margin: '0 0 12px', fontSize: 22, fontWeight: 700, color: '#1f2937'};
const cardBody: React.CSSProperties = {margin: '0 0 4px', fontSize: 15, color: '#374151', lineHeight: 1.6};

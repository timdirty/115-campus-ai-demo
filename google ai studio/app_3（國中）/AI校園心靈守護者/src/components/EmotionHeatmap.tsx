...
const TH_ZONE: React.CSSProperties = {padding: '4px 8px', textAlign: 'left', color: '#6b7280', fontWeight: 700, whiteSpace: 'nowrap'};
const TH_TIME: React.CSSProperties = {padding: '4px 6px', color: '#6b7280', fontWeight: 700, textAlign: 'center', whiteSpace: 'nowrap'};
const TD_ZONE: React.CSSProperties = {padding: '4px 8px', fontWeight: 700, color: '#374151', whiteSpace: 'nowrap'};

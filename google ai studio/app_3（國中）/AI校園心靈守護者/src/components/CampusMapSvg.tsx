export function CampusMapSvg() {
  return (
    ...
    >
      ...
      {/* 圖書館 */}
      <g aria-label="圖書館">
        <rect x="10" y="10" width="100" height="70" rx="8" fill="#dbeafe" stroke="#93c5fd" strokeWidth="1.5" />
        <text x="60" y="43" textAnchor="middle" fontSize="12" fill="#1e40af" fontWeight="700">圖書館</text>
        {/* bookshelf lines */}
        <line x1="22" y1="55" x2="78" y2="55" stroke="#93c5fd" strokeWidth="1" />
        <line x1="22" y1="63" x2="78" y2="63" stroke="#93c5fd" strokeWidth="1" />
        <line x1="22" y1="71" x2="78" y2="71" stroke="#93c5fd" strokeWidth="1" />
      </g>

      {/* 穿堂 */}
      <g aria-label="穿堂">
        <rect x="120" y="10" width="80" height="70" rx="8" fill="#d1fae5" stroke="#6ee7b7" strokeWidth="1.5" />
        <text x="160" y="49" textAnchor="middle" fontSize="12" fill="#065f46" fontWeight="700">穿堂</text>
      </g>

      {/* 操場 */}
      <g aria-label="操場">
        <rect x="300" y="10" width="90" height="200" rx="8" fill="#fef9c3" stroke="#fde047" strokeWidth="1.5" />
      ...
      {/* 九年級教室 */}
      <g aria-label="九年級教室">
        <rect x="10" y="118" width="150" height="80" rx="8" fill="#ede9fe" stroke="#a78bfa" strokeWidth="1.5" />
      ...
      {/* 體育館 */}
      <g aria-label="體育館">
        <rect x="170" y="118" width="120" height="80" rx="8" fill="#fed7aa" stroke="#fb923c" strokeWidth="1.5" />

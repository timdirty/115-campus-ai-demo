...
export const defaultNotes: WhiteboardNote[] = [
  {
    ...
    boardRegions: [
      {id: 'A', label: '左區', x: 5, y: 12, width: 43, height: 76, status: 'keep', reason: '孩子還需要看圖理解分母'},
      {id: 'B', label: '右區', x: 52, y: 12, width: 43, height: 76, status: 'erasable', reason: '練習題已保存，可換下一題'},
    ],
    aiRecommendation: '保留左區披薩圖重點，右區練習題已保存，可清出空間給下一題。',
    linkedTaskIds: [],
    date: '4月29日',
    time: '上午 09:20',
    theme: 'secondary',
  ...
  },
  {
    ...
    boardRegions: [
      {id: 'A', label: '左區', x: 5, y: 12, width: 43, height: 76, status: 'keep', reason: '圖像能幫助孩子說出流程'},
      {id: 'B', label: '右區', x: 52, y: 12, width: 43, height: 76, status: 'erasable', reason: '小組任務已保存，可換下一輪活動'},
    ],
    aiRecommendation: '保留左區旅行圖，右區整理內容已保存，可清出空間。',
    linkedTaskIds: [],
    date: '4月28日',
    time: '下午 01:35',
    theme: 'tertiary',
  ...
  },
  {
    ...
    boardRegions: [
      {id: 'A', label: '左區', x: 5, y: 12, width: 43, height: 76, status: 'keep', reason: '表格是孩子整理故事的支架'},
      {id: 'B', label: '右區', x: 52, y: 12, width: 43, height: 76, status: 'erasable', reason: '範例已保存，可換孩子自己的故事'},
    ],
    aiRecommendation: '保留左區六要素表格，右區範例故事可清出空間給孩子上台分享。',
    linkedTaskIds: [],
    date: '4月27日',
    time: '上午 10:10',
    theme: 'primary',
...
export const defaultClassroomSession: ClassroomSession = {
  ...
  teacherPace: 'normal',
  savedMinutes: 3.1,
  currentRecommendation: '多數孩子已完成右區練習，建議保留左區圖解，先清出右區空間給下一題。',
  boardRegions: [
    {id: 'A', label: '左區', x: 5, y: 12, width: 43, height: 76, status: 'keep', reason: '孩子還需要看圖說明自己的想法'},
    {id: 'B', label: '右區', x: 52, y: 12, width: 43, height: 76, status: 'erasable', reason: '練習已保存，可換下一題'},
  ],
  hardwareProfile: {
    cameraMounted: false,
    boardAnchored: false,
...
export function createNote(input: Partial<WhiteboardNote> & Pick<WhiteboardNote, 'title' | 'subject' | 'content'>): WhiteboardNote {
  ...
  return {
    ...
    contentType: input.contentType ?? 'question',

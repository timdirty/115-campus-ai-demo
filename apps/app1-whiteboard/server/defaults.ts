...
export const defaultNotes: WhiteboardNote[] = [
  {
    ...
    boardRegions: [
      {id: 'A', label: '左側重點區', x: 8, y: 18, width: 40, height: 62, status: 'keep', reason: '孩子還需要看圖理解分母'},
      {id: 'B', label: '右側練習區', x: 54, y: 18, width: 38, height: 62, status: 'erasable', reason: '練習題已保存，可換下一題'},
    ],
    aiRecommendation: '保留左側披薩圖重點，右側練習題已保存，可清出空間給下一題。',
    linkedTaskIds: [],
    date: '4月29日',
    time: '上午 09:20',
    theme: 'secondary',
  ...
  },
  {
    ...
    boardRegions: [
      {id: 'A', label: '左側圖解區', x: 8, y: 18, width: 42, height: 62, status: 'keep', reason: '圖像能幫助孩子說出流程'},
      {id: 'B', label: '右側整理區', x: 56, y: 18, width: 36, height: 62, status: 'erasable', reason: '小組任務已保存，可換下一輪活動'},
    ],
    aiRecommendation: '保留左側旅行圖，右側整理區已保存，可清出空間。',
    linkedTaskIds: [],
    date: '4月28日',
    time: '下午 01:35',
    theme: 'tertiary',
  ...
  },
  {
    ...
    boardRegions: [
      {id: 'A', label: '左側六要素區', x: 8, y: 18, width: 42, height: 62, status: 'keep', reason: '表格是孩子整理故事的支架'},
      {id: 'B', label: '右側練習區', x: 56, y: 18, width: 36, height: 62, status: 'erasable', reason: '範例已保存，可換孩子自己的故事'},
    ],
    aiRecommendation: '保留左側六要素表格，右側範例故事可清出空間給孩子上台分享。',
    linkedTaskIds: [],
    date: '4月27日',
    time: '上午 10:10',
    theme: 'primary',
...
export const defaultClassroomSession: ClassroomSession = {
  ...
  teacherPace: 'normal',
  savedMinutes: 3.1,
  currentRecommendation: '多數孩子已完成右側練習，建議保留左側圖解，先清出右側空間給下一題。',
  boardRegions: [
    {id: 'A', label: '左側重點區', x: 8, y: 18, width: 40, height: 62, status: 'keep', reason: '孩子還需要看圖說明自己的想法'},
    {id: 'B', label: '右側練習區', x: 54, y: 18, width: 38, height: 62, status: 'erasable', reason: '練習已保存，可換下一題'},
  ],
  hardwareProfile: {
    servoAngles: {
      regionA: 20,

...
const BOARD_TEMPLATES: ChatTemplate[] = [
  ...
  },
  {
    ...
    answer: '教師看板有「老師用進階設定」。學生展示時可以略過；接上實體機器人時，老師再調整 A、B、C 區塊的位置。',
  },
  {
...
const ROBOT_TEMPLATES: ChatTemplate[] = [
  {
    ...
    answer: '板擦機器人會依照老師指定的 A、B、C 區塊移動。收到任務後，它會先到指定位置，再執行擦除或等待。',
  },
  {
  ...
  },
  {
    ...
    answer: '機器人控制頁面可以送出常用任務，例如擦除 A、B、C 區、全板擦除、暫停等待、成功動畫。學生展示時只要按畫面上的中文按鈕即可。',
  },
  {
    keywords: ['伺服', 'servo', '角度', '校準', '調整'],
    answer: '實體機器人第一次安裝時，需要由老師調整 A、B、C 區塊位置。學生展示時可以略過這段，直接走主流程。',
  },
  {

...
const EV3_BUTTONS: {label: string; command: string; className?: string}[] = [
  ...
  {label: '停止', command: 'EV3_STOP', className: 'rounded-lg bg-red-500 px-2 py-2 text-xs font-medium text-white transition hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-40'},
];
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="text-sm font-semibold text-gray-700">老師筆臂控制</h3>

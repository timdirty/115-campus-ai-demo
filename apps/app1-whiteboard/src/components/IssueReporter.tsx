...
export function IssueReporter({
  ...
  return (
    <>
      {/* FAB */}
      <div data-teacher-tool="issue-reporter" style={{ position: 'fixed', bottom: 20, left: 20, zIndex: 9000 }}>
        {openCount > 0 && !open && (
          <motion.div
